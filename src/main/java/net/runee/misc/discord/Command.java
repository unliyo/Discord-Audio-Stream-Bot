...
public abstract class Command {
    ...
    protected void reply(SlashCommandInteractionEvent ctx, CharSequence text, Color color) {
        reply(ctx, null, null, text, color, _public);
    }

    protected void reply(SlashCommandInteractionEvent ctx, String title, String url, CharSequence text, Color color) {
        reply(ctx, title, url, text, color, _public);
    }

    protected void reply(SlashCommandInteractionEvent ctx, String title, String url, CharSequence text, Color color, boolean _public) {
    ...
    protected void ensureOptionAbsent(SlashCommandInteractionEvent ctx, String optionName) throws IllegalOptionException {
        if (ctx.getOption(optionName) != null) {
            throw new IllegalOptionException(this, ctx, optionName);
        }
    }
